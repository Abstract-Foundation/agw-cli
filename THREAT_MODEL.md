...
- Session signer material and session config stored at `~/.agw-mcp/`.
...
| Prompt injection causing unintended state-changing calls | Structured input validation on all tool handlers. Write tools require explicit `execute: true` confirmation. |
